      ...
      dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
        <div className="w-100 text-center">
          ...
          <Link to={'/resume.pdf'} target='_blank' download>
             <Button color={'bg-[#5271ff] text-white hover:bg-white hover:text-black w-max mx-auto hover:border-[#ccc] border-[1px]'} label={'Download Resume'} icon={<IoMdArrowForward/>} />
          </Link>
        </div>
        <hr className='my-10'/>
        <CV user={ResumeData}/>
