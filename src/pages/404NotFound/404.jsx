    ...
    return (
        <div className="px-2 pt-[5rem] pb-10 overflow-auto w-[100%] overflow-y-auto [&::-webkit-scrollbar]:w-2
            ...
            <div className="flex flex-col h-full items-center justify-center text-center w-[100%]">
                ...
                <Link to={'/'}><Button label={'Back To Home'} color={'bg-[#5271ff] text-white hover:bg-[#000000] hover:text-white py-3 px-6 gap-2 rounded-full capitalize flex items-center mt-5'}/></Link>
            </div>
        </div>
    )
}
