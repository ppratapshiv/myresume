  ...
  return(
    ...
    dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
      <div className='w-[80%] text-center mx-auto'>
          ...
          <Link to='/contact'>
              <Button color={'bg-[#5271ff] text-white hover:bg-white hover:text-black w-max mx-auto hover:border-[#ccc] border-[1px]'} label={'Hire Me'} icon={<PiPaperPlaneTilt/>}/>
          </Link>
      </div>
      <hr className='my-20'/>
      <div className="flex items-end">
          <div className="w-[80%]">
            <SectionTitle secTitle='Service Packages' secSubTitle="Explore the range of services I provide to help bring your projects to life. From initial concept to final delivery, I am committed to delivering high-quality results tailored to your needs." exClassName={'border-l-4 border-[#5271ff] pl-4'}/>
          </div>
        </div>
