...
function TechBox({techicon, techTitle, techDesc}){
    return(
        <div className="bg-[rgb(250,250,250)] p-5 lg:w-1/3 xl:w-[23.99%] border-[#ccc] border-[1px] hover:bg-[#ffffff] hover:border-[#5271ff] transition-all duration-300 ease-in-out">
