  ...
  return (
    ...
    dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
      <div className="flex flex-col mx-auto text-center text-black gap-3 my-10">
              ...
              <NavLink 
                ...
                className={({ isActive }) => 
                  `flex items-center gap-2 px-4 py-2 rounded-md transition duration-200 ${
                    isActive ? "bg-[#5271ff] text-white" : "hover:bg-gray-200"
                  }`
                }
              >
        ...
        <Link to={'/contact'}>
          <Button icon={<PiPaperPlaneTilt/>} label='Hire Me' color={'bg-[#5271ff] text-white hover:bg-black hover:text-white w-max mx-auto'}/>
        </Link>
      </div>
    </div>
  );
